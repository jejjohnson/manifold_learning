...
% Final matrix
A = imgVec' * (L + gamma * scUEqL * UpU) * imgVec;
B = imgVec' * D * imgVec;
toc;
...
tic;
[embedding, lambda] = eigs(A, B, numEigs, 'SM');
toc;
...
hTitle = title('SEPPL + LDA, SVM - Indian Pines - 25');
...
% Save the figure
print('saved_figures/seppl_ldasvm_test - 25', '-depsc2');
